...
public class CompareProg {
	...
	/**
	 * Check observational equivalence between two probLangs Using the vars that are common to the p2 and p1 programs
	 *
	 * @param p1
	 * @param p2
	 * @return
	...
	/**
	 * Check observational equivalence between two problangs Using the vars in params
	 *
	 * @param p1
	 * @param p2
	 * @param vars
